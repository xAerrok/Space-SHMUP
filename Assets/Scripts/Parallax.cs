...
public class Parallax : MonoBehaviour
{
    ...
    [Tooltip("Controls how much panels react to player movement (Defalut 0.25)")]
    ...
    void Update()
    {
        ...
        if (tY >= 0) { panels[1].position = new Vector3(tX, tY -panelHt, depth); }
        else { panels[1].position = new Vector3(tX, tY +panelHt, depth); }
    }
}
